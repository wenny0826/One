package com.wenny.wennylibrary.widget.slidbarView;
...
public class SlidBarView extends View {
    ...
    private String[] cotents = {"当前","热门","A","B","C","D","E","F","G","H","J","K","L","M","N","P","Q","R","S","T","W","X","Y","Z"};
    ...
    protected void onDraw(Canvas canvas) {
        for (int i = 0; i < cotents.length; i++) {
            if(i == 0 || i == 1){
                strPaint.setTextSize(12);
            }
            strPaint.setTextSize(30);
            if(i == index){
                strPaint.setColor(Color.parseColor("#3FBEE4"));
            } else {
                strPaint.setColor(Color.GRAY);
            }
